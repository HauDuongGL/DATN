...
import 'package:verify_clone/utils/extensions/map_extension.dart';
...
class RemoteException extends AppException {
  ...
  factory RemoteException.fromJson(Map<String, dynamic> json) {
    return RemoteException(
        ...
        overrideMessage: json.stringValueOrNull('message'));
  }
  ...
  @override
  String toString() =>
      'RemoteException(httpCode: $httpCode, kind: $kind, overrideMessage: $overrideMessage)';
}
