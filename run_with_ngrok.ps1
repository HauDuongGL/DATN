...
if (-not (Get-Command ngrok -ErrorAction SilentlyContinue)) {
    throw "ngrok is not installed or not on PATH. Download from https://ngrok.com/download and install first."
}
...
$ngrokProcess = Start-Process -FilePath "ngrok" -ArgumentList $ngrokArgs -NoNewWindow -RedirectStandardOutput $ngrokLogPath -PassThru
